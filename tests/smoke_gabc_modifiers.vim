...
call setline(24, '(gx) Flat')
call setline(25, '(g#) Sharp')
call setline(26, '(gy) Natural')
call setline(27, '(gx?) Parenthesized flat')
call setline(28, '(g#?) Parenthesized sharp')
call setline(29, '(gy?) Parenthesized natural')
call setline(30, '(g##) Soft sharp')
call setline(31, '(gY) Soft natural')
